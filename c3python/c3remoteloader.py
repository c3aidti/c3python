...
>>> get_c3("https://dti-dadams.c3dti.ai","dti", "dadams")
"""
...
class C3RemoteLoader(object):
    ...
    def _mod_to_paths(self, fullname):
        ...
        if fullname == self.package_prefix:
            return os.path.join(self.package_prefix, '__init__.py')
    ...
    def load_module(self, fullname):
        ...
        if filename.endswith('__init__.py'):
            ...
            # Do not load source here since it will be empty in prefix-package
        else:
